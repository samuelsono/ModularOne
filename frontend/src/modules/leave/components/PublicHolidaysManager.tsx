...
import type { PublicHoliday, SavePublicHolidayRequest } from '@modules/leave/types/leave';
import AppTitle from '@platform/ui/AppTitle';
import { usePageSearchQuery } from '@platform/shell/PageSearchContext';
import { filterPublicHolidays } from '@modules/leave/search/filters';
    ...
    <div className="flex flex-col gap-4">
      <div className="flex items-start justify-between gap-4 px-3">
        ...
        <div className='flex items-end gap-3'>
          ...
          <Field label="Year">
          <SpinButton value={year} className="max-w-[140px]" onChange={(_, data) => setYear(Number.parseInt(String(data.value ?? ''), 10) || currentYear)} />
      </Field>
