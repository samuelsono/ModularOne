...
import { createPosition, getDepartments, updatePosition } from '@modules/coreHr/services/coreHrService';
import type { Department, SavePositionRequest } from '@modules/coreHr/types/coreHr';
