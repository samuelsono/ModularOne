...
import { DepartmentFormDialog } from '@modules/coreHr/components/DepartmentFormDialog';
...
import { getDepartments } from '@modules/coreHr/services/coreHrService';
import type { Department, SaveDepartmentRequest } from '@modules/coreHr/types/coreHr';
...
export default function DepartmentsPage() {
  ...
  const columns = useMemo<TableColumnDefinition<Department>[]>(() => withAuditableColumns([
    ...
    createTableColumn<Department>({ columnId: 'isActive', renderHeaderCell: () => 'Status', renderCell: (item) => <StatusBadge status={item.isActive ? 'Active' : 'Inactive'} /> }),
