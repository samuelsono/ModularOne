...
import type { DashboardRender } from '@modules/reporting/types/dashboard';
import { usePageSearchQuery } from '@platform/shell/PageSearchContext';
import { getDashboardRender } from '@modules/reporting/services/dashboardService';
import { getSelectedDashboardId, setSelectedDashboardId, DASHBOARD_CHANGED_EVENT } from '@modules/reporting/utils/dashboardStorage';
import { filterDashboardRender } from '@modules/reporting/search/filters';
