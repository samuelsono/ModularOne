...
export function DetailRow({
  ...
  return (
    <div
      className="grid grid-cols-[20px_140px_1fr] items-center gap-3 border-b py-2.5 last:border-b-0"
...
export const detailPanelShellClassName =
  'flex max-h-[90vh] w-full max-w-[640px] flex-col overflow-hidden rounded border shadow-sm';

export const detailPanelShellStyle: CSSProperties = {
  backgroundColor: tokens.colorNeutralBackground1,
  borderColor: tokens.colorNeutralStroke3,
};

export const detailPanelHeaderClassName = 'border-b px-6 pb-4 pt-6';

export const detailPanelHeaderStyle: CSSProperties = {
  borderBottomColor: tokens.colorNeutralStroke3,
};

export const detailPanelBodyClassName = 'flex-1 overflow-y-auto px-6';

export const detailPanelFooterClassName = 'border-t px-6 py-4';

export const detailPanelFooterStyle: CSSProperties = {
