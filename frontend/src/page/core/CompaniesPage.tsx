...
import { CompanyFormDialog } from '../../components/coreHr/CompanyFormDialog';
...
import { getCompanies } from '../../services/coreHrService';
import type { Company, SaveCompanyRequest } from '../../types/coreHr';
...
export default function CompaniesPage() {
  ...
  const columns = useMemo<TableColumnDefinition<Company>[]>(() => withAuditableColumns([
    ...
    createTableColumn<Company>({ columnId: 'isActive', renderHeaderCell: () => 'Status', renderCell: (item) => <ExpenseStatusBadge status={item.isActive ? 'Active' : 'Inactive'} /> }),
