...
import { getDashboard, getDashboards } from '../../services/dashboardService';
import { getSelectedDashboardId, notifyDashboardChanged } from '../../utils/dashboardStorage';
import { createReport, getReportMetadata, previewReport, updateReport } from '../../services/reportService';
import type {
  Report,
  ReportFilter,
  ReportMetadata,
...
import type { DashboardSection, DashboardSummary } from '../../types/dashboard';
import { buildSectionTree, flattenSectionTree, getSectionLabel } from '../../utils/sectionTree';
import {
  API_RESOURCE_LABELS,
