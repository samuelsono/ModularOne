...
import { createUserFromDriver, getManagerOptions } from '../../services/userService';
import type { Driver } from '../../types/driver';
import type { ManagerOption } from '../../types/user';
          ...
          <DialogContent className="flex flex-col gap-3 pt-2">
            ...
            <Field label="Manager">
              <Dropdown
                ...
                value={managers.find((manager) => manager.id === managerUserId)?.displayName ?? ''}
