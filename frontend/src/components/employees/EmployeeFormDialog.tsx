...
import type { CreateUserRequest, ManagerOption, UpdateUserRequest, UserListItem } from '../../types/user';
import { APP_ROLES } from '../../types/user';
import { usePermissions } from '../../hooks/usePermissions';
import { getCompanies, getDepartments, getPositions } from '../../services/coreHrService';
import type { Company, Department, Position } from '../../types/coreHr';
