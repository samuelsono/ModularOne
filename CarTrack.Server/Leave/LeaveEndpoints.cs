...

{
...

    {
...

        {
            ...
            await TryNotifyAsync(
                ...
                () => NotificationTriggers.NotifyLeaveSubmittedAsync(
...

    {
...

        {
            ...
            await TryNotifyAsync(
                ...
                () => NotificationTriggers.NotifyLeaveCancelledAsync(
...

        {
            ...
            await TryNotifyAsync(
                ...
                () => request.Approve
                    ...
                    ? NotificationTriggers.NotifyLeaveApprovedAsync(
                    ...
                    : NotificationTriggers.NotifyLeaveRejectedAsync(
...

    {
...

        {
            ...
            branch = await ManagerHierarchy.ResolveRequesterBranchAsync(
