...
public static class VehicleEndpoints
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            await TryNotifyAsync(
                () => NotificationTriggers.NotifyVehicleCreatedAsync(
                    notificationService,
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            await TryNotifyAsync(
                () => NotificationTriggers.NotifyVehicleUpdatedAsync(
                    notificationService,
                    vehicle.RegistrationNumber,
                    cancellationToken),
                logger);
        ...
        CancellationToken cancellationToken)
    {
        ...
        await TryNotifyAsync(
            () => NotificationTriggers.NotifyVehicleDeletedAsync(
                notificationService,
                deletedCount,
                cancellationToken),
            logger);
        ...
        CancellationToken cancellationToken)
    {
        ...
        await TryNotifyAsync(
            () => NotificationTriggers.NotifyVehicleSyncedAsync(
                notificationService,
                result.Created,
                result.Updated,
                cancellationToken),
