...
public interface IReportQueryService
{
    ...
    Task<ReportExecutionResultDto> ExecuteAsync(ReportDefinition report, CancellationToken cancellationToken = default);
    ...
    IApiTableReportExecutor apiTableReportExecutor) : IReportQueryService
{
    ...
    {
        IQueryable<Vehicle> query = dbContext.Vehicles.AsNoTracking().Where(vehicle => !vehicle.IsDeleted);
    ...
    private async Task<ReportExecutionResultDto> ExecuteLeaveRequestsAsync(
        ...
        CancellationToken cancellationToken)
    {
        IQueryable<LeaveRequest> query = dbContext.LeaveRequests.AsNoTracking();
    ...
    private async Task<ReportExecutionResultDto> ExecuteLeaveBalancesAsync(
        ...
        CancellationToken cancellationToken)
    {
        IQueryable<LeaveBalance> query = dbContext.LeaveBalances.AsNoTracking();
    ...
    private async Task<ReportExecutionResultDto> ExecuteExpenseClaimsAsync(
        ...
        CancellationToken cancellationToken)
    {
        IQueryable<ExpenseClaim> query = dbContext.ExpenseClaims.AsNoTracking();
    ...
    private async Task<ReportExecutionResultDto> ExecuteDepartmentsAsync(
        ...
        CancellationToken cancellationToken)
    {
        IQueryable<Department> query = dbContext.Departments.AsNoTracking();
    ...
    private async Task<ReportExecutionResultDto> ExecuteStaffProfilesAsync(
        ...
        CancellationToken cancellationToken)
    {
        IQueryable<StaffProfile> query = dbContext.StaffProfiles.AsNoTracking();
