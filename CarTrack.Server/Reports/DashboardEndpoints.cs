...
public static class DashboardEndpoints
{
    ...
    private static async Task<IResult> CreateDashboardAsync(
        ...
        CancellationToken cancellationToken)
    {
        var validationError = ToValidationResult(ReportValidator.ValidateDashboard(request));
    ...
    private static async Task<IResult> CreateSectionAsync(
        ...
        CancellationToken cancellationToken)
    {
        var validationError = ToValidationResult(ReportValidator.ValidateSection(request));
        if (validationError is not null)
        {
            return validationError;
        }
